          ...
          <div class="row no-gutters">
            <div class="col-md-12">
              <div class="bannerimgmain">
                ...
                <div class="pagetitletopbanner"><h2 class="titletext">Upcoming Bookings</h2></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row secmain">
            <div class="col-md-12 p-0">
              ...
              <ul class="nav nav-tabs navtabscustm">
               <li class="nav-item">
                 <a class="nav-link active" href="{{route('upcoming-bookings')}}">Upcoming</a>
               </li>
               <li class="nav-item">
                 <a class="nav-link" href="{{route('completed-bookings')}}">Completed</a>
               </li>
             </ul>
